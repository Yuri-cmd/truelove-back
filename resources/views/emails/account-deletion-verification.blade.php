<!-- resources\views\emails\account-deletion-verification.blade.php -->
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>Verificación de eliminación de cuenta</title>
</head>
                ...
                <table cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="margin: 0 0 20px;">Has solicitado la eliminación de tu cuenta en TRUE LOVE. Para verificar tu identidad y continuar con el proceso, por favor utiliza el siguiente código de verificación:</p>
                            ...
                            <p style="margin: 20px 0 0; color: #666;">
                                <strong>Importante:</strong> Este código expira en 15 minutos. Una vez verificado, tu solicitud será revisada por nuestro equipo en un plazo de 24-72 horas.
                            </p>

                            <p style="margin: 20px 0 0;">Si no has solicitado la eliminación de tu cuenta, por favor ignora este correo y tu cuenta permanecerá activa.
                            </p>
                        </td>
                    </tr>
                </table>
